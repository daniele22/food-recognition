...
checkpoint_config = dict(
    ...
    out_dir='/content/drive/My Drive/ML/htc_x101',  # the directory in which save checkpoints
    save_last=True) 
...
# runtime settings
load_from = '/content/drive/My Drive/ML/htc_x101/epoch_20_all.pth'   # used to load the model
...
work_dir = '/content/drive/My Drive/ML/htc_x101/logs'
