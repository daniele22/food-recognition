...
checkpoint_config = dict(
    ...
    out_dir='/content/drive/MyDrive/ML/models/mask_rcnn_r50',  # the directory in which save checkpoints
    save_last=True) 
...
load_from = '/content/drive/MyDrive/ML/models/mask_rcnn_r50/epoch_10.pth'  # used to load the model
resume_from = None  # used to resume and continue an experiment ( resume also the optimizer )
workflow = [('train', 1)]  # use [('train', 1), ('val', 1)] to do an epoch for training and one for validating

# working dir in with the logs are saved and also the checkpoints if another folder is not specified in checkpoint_config
work_dir = '/content/drive/MyDrive/ML/models/mask_rcnn_r50/logs'
