...
checkpoint_config = dict(
    ...
    out_dir='/content/drive/My Drive/ML/models/mask_rcnn_r50',  # the directory in which save checkpoints
    save_last=True) 
...
load_from = '/content/drive/My Drive/ML/models/mask_rcnn_r50/epoch_10.pth'  # used to load the model
...
work_dir = '/content/drive/My Drive/ML/models/mask_rcnn_r50/logs'
